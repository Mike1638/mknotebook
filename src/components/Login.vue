        ...
        <div class="modal-container">
          ...
          <div class="form">
            ...
            <div v-show="isShowRegister" class="register">
              <input type="text" v-model="register.name" placeholder="用户名" />
            ...
            <div v-show="isShowLogin" class="login">
              <input type="text" v-model="login.name"  placeholder="输入用户名" />
              <input type="text" v-model="login.password"  placeholder="输入密码" />
