  ...
  <div class="note-sidebar">
    ...
    <el-dropdown class="notebook-title" @command="handleCommand" placement="bottom">
      ...
      <el-dropdown-menu slot="dropdown">
        <el-dropdown-item  v-for="(item,index) in notebooks" :key="index"  :command="item.id">{{item.title}}</el-dropdown-item>
    ...
    handleCommand(notebookId) {
        if(notebookId =='trash'){
          this.$router.push('/trash')
            ...
            this.currentBook =  this.notebooks.find(item=>item.id == notebookId)  || {}
